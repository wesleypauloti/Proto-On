...
class MyApp(MDApp):    
    ...
    def cadastrar_municipe_button_pressed(self, text):
        ...
        # if senha != senha2:
        #     self.text = "Confirmação de senha diferente da senha"
        # else:
        self.text = text
    ...
    def cadastrar_reclamacao_button_pressed(self, text):
        # Chame a função save_to_database do arquivo database_manager.py
        ...
        validate = True
        save_reclamacao(idMunicipe, nomeMunicipe, problema, bairro, rua, descricao, validate)
    ...
    def exibir_consulta(self, *args):
        ...
        if login_result is not None:
            ...
            if reclamacoes:
                ...
                self.root.ids.requerente_label.text = f'{reclamacoes[0][2]}'
                self.root.ids.problema_label.text = f'{reclamacoes[0][3]}'
                self.root.ids.bairro_label.text = f'{reclamacoes[0][4]}'
                self.root.ids.status_label.text = f'{reclamacoes[0][7]}'
            else:
